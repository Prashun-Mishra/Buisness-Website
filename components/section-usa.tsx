...
export default function SectionUSA() {
  ...
  const features = [
    ...
    {
      title: 'Banking & ITIN Application',
      subtitle: 'Complete Setup',
      description: 'Seamless US business banking setup with merchant accounts, payment processing, and complete ITIN infrastructure for your growing business.',
