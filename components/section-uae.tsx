...
export default function SectionUAE() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Complete end-to-end legal entity formation and work permits with dedicated expert guidance throughout your UAE business journey.',
      features: ['PRO Services', 'Work Permits', 'Legal Entity Setup'],
      icon: FileCheck,
      image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=2072&auto=format&fit=crop',
      stats: { label: 'Licenses Processed', value: '1000+' },
    },
    {
      title: 'Compliance Support',
      subtitle: 'Regulatory Assurance',
      description: 'Stay compliant with ongoing regulatory support and complete peace of mind for your UAE operations and business growth.',
      features: ['Corporate Tax Filing', 'Regulatory Filing', 'Documentation Support', '24/7 Expert Help'],
      icon: Scale,
